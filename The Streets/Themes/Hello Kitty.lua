...
local Settings       = {
    Trails           = {
        ...
        Brightness   = 3,
        Color        = CNew{CKNew(0, C3(240, 120, 240)), CKNew(0.4, C3(240, 120, 240)), CKNew(1, C3(215, 123, 255))}
                       },
    ...
    Bullets          = {
        ...
        Material     = Enum.Material.Neon,
        Transparency = 1,
        Color        = Color3.fromRGB(215, 123, 255),
        Effects      = true,
        EffectID     = 'rbxassetid://11351620343'
                       },
    ...
    UserInterface    = {
        Ammo         = true,
        AmmoColor    = '255, 198, 254',
        Cash         = true,
        CustomHUD    = true,
        Logo         = true,
        LogoID       = 'rbxassetid://11351620343',
        HUDColor     = Color3.fromRGB(255, 198, 254)
                       },
};
...
RunService.heartbeat:Connect(function()
    ...
    if Settings.UserInterface.Ammo then
        if Client.Character:FindFirstChildOfClass('Humanoid') then 
            if Tool and Tool:FindFirstChild('Ammo') then
                ...
                HUD.Ammo.Text     = '\n\n Ammo: <font color="rgb(' .. Settings.UserInterface.AmmoColor ..')">' .. Tool.Ammo.Value .. '</font>\nClips:  <font color="rgb(' .. Settings.UserInterface.AmmoColor .. ')">'.. Tool.Clips.Value .. '</font>'
    ...
    if Settings.UserInterface.CustomHUD then
        ...
        HUD:WaitForChild('HP').BorderColor3           = Color3.fromRGB(255, 255, 255)
        HUD:WaitForChild('HP').Bar.BackgroundColor3   = Settings.UserInterface.HUDColor
        HUD:WaitForChild('HP').Bar.BorderColor3       = Color3.fromRGB(255, 255, 255)
    
        HUD:WaitForChild('KO').BackgroundColor3       = Color3.fromRGB(0, 0, 0)
        HUD:WaitForChild('KO').BorderColor3           = Color3.fromRGB(255, 255, 255)
        HUD:WaitForChild('KO').Bar.BackgroundColor3   = Settings.UserInterface.HUDColor
        HUD:WaitForChild('KO').Bar.BorderColor3       = Color3.fromRGB(255, 255, 255)
    
        HUD:WaitForChild('Stam').BackgroundColor3     = Color3.fromRGB(0, 0, 0)
        HUD:WaitForChild('Stam').BorderColor3         = Color3.fromRGB(255, 255, 255)
        HUD:WaitForChild('Stam').Bar.BackgroundColor3 = Settings.UserInterface.HUDColor
        HUD:WaitForChild('Stam').Bar.BorderColor3     = Color3.fromRGB(255, 255, 255)
...
-- \|/ Notification \|/ --------------------------------------------------------------------------------------------------
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/difficuItly/linoria/main/Linoria%20Edited'))()
